 ...
 * occupy: SYSTEM_TEST_USERNAME_PREFIX is rejected at registration and at
 * username change. Without that reservation the cron could delete a real
 * account that merely happened to pick the prefix.
 */
