...
const classCatalogItemBaseSchema = z.object({
  id: classIdSchema,
...
export const classCatalogItemSchema = z.discriminatedUnion("icon_type", [
  classCatalogItemBaseSchema.extend({
    icon_type: z.literal("vector"),
    vector_icon: classVectorIconSchema,
    icon_media_id: z.null(),
  }),
  classCatalogItemBaseSchema.extend({
    icon_type: z.literal("image"),
    vector_icon: z.null(),
    icon_media_id: mediaIdSchema,
  }),
]);
