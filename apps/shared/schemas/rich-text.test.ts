...
describe("findRichTextProblem", () => {
  ...
  it("accepts a document using every editor node and mark", () => {
    const fullDocument = doc([
      ...
      { type: "horizontalRule" },
      { type: "image", attrs: { src: "/api/announcements/image?key=announcement/a1/images/img-1", alt: null, title: null } },
      { type: "image", attrs: { src: "wiki/w1/images/img-2", alt: "diagram", title: "Diagram" } },
      {
        type: "table",
        content: [
          {
