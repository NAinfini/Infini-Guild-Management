// Plain-text projection of TipTap JSON used for revision diffing: text nodes
// are concatenated and block-level nodes become lines, so line/char diffs map
// naturally onto the rendered document structure.
