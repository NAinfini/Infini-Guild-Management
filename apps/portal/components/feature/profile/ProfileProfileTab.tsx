...
import { Avatar, Button, Divider, FileButton, Group, NumberInput, Progress, Select, Stack, Text, TextInput, Textarea } from "@mantine/core";
    ...
    <>
      <PortalCard interactive={false}>
        <Stack gap={0} p="1.2rem">
          ...
          <Group gap={8} wrap="nowrap" maw={400}>
            <Select
              searchable
