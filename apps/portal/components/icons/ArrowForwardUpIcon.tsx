...
export interface ArrowForwardUpIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface ArrowForwardUpIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}
...
const ArrowForwardUpIcon = forwardRef<ArrowForwardUpIconHandle, ArrowForwardUpIconProps>(
...
ArrowForwardUpIcon.displayName = "ArrowForwardUpIcon";

export { ArrowForwardUpIcon };
