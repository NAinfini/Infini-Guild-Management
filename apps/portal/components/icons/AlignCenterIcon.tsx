...
const TOP_LINE_VARIANTS: Variants = {
  ...
  animate: { translateX: [2, 0], transition: { duration: 0.4, ease: "easeInOut" } },
};
    ...
    return (
      <div ref={wrapperRef} className={cn(className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props}>
        <svg fill="none" height={size} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width={size} xmlns="http://www.w3.org/2000/svg">
          ...
          <motion.path animate={controls} d="M8 12l8 0" initial="normal" variants={MIDDLE_LINE_VARIANTS} />
          <motion.path animate={controls} d="M6 18l12 0" initial="normal" variants={BOTTOM_LINE_VARIANTS} />
        </svg>
      </div>
    );
  },
