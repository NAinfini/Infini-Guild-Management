...
interface LinkOffIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}

const TOP_LINK_VARIANTS: Variants = {
  normal: { translateX: 0, translateY: 0, transition: { duration: 0.3, ease: "easeOut" } },
  animate: { translateX: [0, 1.5, 1.5, 0], translateY: [0, -1.5, -1.5, 0], transition: { duration: 0.6, ease: "easeInOut" } },
};
...
const LinkOffIcon = forwardRef<LinkOffIconHandle, LinkOffIconProps>(
