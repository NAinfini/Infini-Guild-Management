...
export interface SwordIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface SwordIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}

const SVG_VARIANTS: Variants = {
  normal: { rotate: 0, transition: { duration: 0.3, ease: "easeOut" } },
  animate: { rotate: [0, -15, 5, 0], transition: { duration: 0.4, ease: "easeInOut" } },
};

const SwordIcon = forwardRef<SwordIconHandle, SwordIconProps>(
