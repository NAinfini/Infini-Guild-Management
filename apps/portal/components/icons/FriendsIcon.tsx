...
export interface FriendsIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface FriendsIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}
...
const FriendsIcon = forwardRef<FriendsIconHandle, FriendsIconProps>(
