...
export interface WorldIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface WorldIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}

const SVG_VARIANTS: Variants = {
  normal: { rotate: 0, transition: { duration: 0.4, ease: "easeOut" } },
  animate: { rotate: 20, transition: { duration: 0.6, type: "spring", stiffness: 150, damping: 12 } },
};

const WorldIcon = forwardRef<WorldIconHandle, WorldIconProps>(
