...
export interface RowRemoveIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface RowRemoveIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}
...
const RowRemoveIcon = forwardRef<RowRemoveIconHandle, RowRemoveIconProps>(
    ...
    return (
      <div ref={wrapperRef} className={cn(className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props}>
        <svg fill="none" height={size} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" width={size} xmlns="http://www.w3.org/2000/svg">
          ...
          <motion.g animate={controls} initial="normal" style={{ transformOrigin: "12px 18px" }} variants={X_VARIANTS}>
            <path d="M10 16l4 4" />
            <path d="M10 20l4 -4" />
          </motion.g>
        </svg>
