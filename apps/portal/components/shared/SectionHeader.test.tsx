...
describe("SectionHeader", () => {
  it("exposes the section title as a level-three heading", () => {
    ...
    expect(screen.getByRole("heading", { level: 3, name: "Media" })).not.toHaveClass(
      "section-header__title--major",
    );
  ...
  it("supports a page-level h2 without changing the default card heading", () => {
    ...
    expect(screen.getByRole("heading", { level: 2, name: "Class catalog" })).toHaveClass(
      "section-header__title--major",
    );
  });
});
