...
export const AUDIT_COVERAGE = [
  ...
  audited("IdentityAdminService.credentialAdmin", "auth/identity-admin-service.ts", "user_auth", ["reset_password", "reset_login_lock"], "AuthStore transaction"),
  audited("AuthService.registration", "auth/auth-service.ts", "user", ["register"], "AuthStore transaction"),
  audited("AuthService.accountCredentials", "auth/auth-service.ts", "user_auth", ["change_password", "change_username"], "AuthStore transaction"),
  ...
  audited("AnnouncementService.mutations", "announcements/announcement-service.ts", "announcement", ["create", "update", "archive", "delete", "upload_images"], "AnnouncementStore transaction"),
  ...
  audited("GalleryService.mutations", "gallery/gallery-service.ts", "gallery_item", ["upload_images", "create_video", "delete", "batch_delete"], "GalleryStore transaction"),
