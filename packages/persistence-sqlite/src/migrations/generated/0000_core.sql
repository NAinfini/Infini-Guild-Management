...
CREATE INDEX `idx_announcements_public` ON `announcements` (`status`,`pinned`,`updated_at`,`id`,`publish_at`,`expires_at`);--> statement-breakpoint
CREATE INDEX `idx_announcements_manage` ON `announcements` (`pinned`,`updated_at`,`id`,`archived_at`,`status`);--> statement-breakpoint
CREATE INDEX `idx_announcements_schedule` ON `announcements` (`status`,`publish_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_announcements_expiry` ON `announcements` (`status`,`expires_at`,`id`);--> statement-breakpoint
CREATE TABLE `audit_archive_items` (
	`archive_id` text NOT NULL,
	`audit_id` text NOT NULL,
	`position` integer NOT NULL,
	PRIMARY KEY(`archive_id`, `audit_id`),
	FOREIGN KEY (`archive_id`) REFERENCES `audit_archives`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`audit_id`) REFERENCES `audit_log`(`id`) ON UPDATE no action ON DELETE cascade,
	CONSTRAINT "audit_archive_items_position_valid" CHECK("audit_archive_items"."position" BETWEEN 0 AND 99)
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_audit_archives_object_key` ON `audit_archives` (`object_key`);--> statement-breakpoint
CREATE UNIQUE INDEX `ux_audit_archives_one_pending` ON `audit_archives` (`status`) WHERE "audit_archives"."status" = 'pending';--> statement-breakpoint
CREATE INDEX `idx_audit_archives_month_ready` ON `audit_archives` (`month`,`status`,`created_at`,`id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_invite_links_token_digest` ON `invite_links` (`token_digest`);--> statement-breakpoint
CREATE INDEX `idx_invite_links_created` ON `invite_links` (`created_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_invite_links_status` ON `invite_links` (`revoked_at`,`expires_at`,`used_count`,`max_uses`);--> statement-breakpoint
CREATE INDEX `idx_invite_links_role` ON `invite_links` (`role_id`);--> statement-breakpoint
CREATE TABLE `login_failures` (
	`username` text PRIMARY KEY NOT NULL,
	`fail_count` integer DEFAULT 0 NOT NULL,
	`locked_until` text,
	`last_failed_at` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL,
	CONSTRAINT "login_failures_count_nonnegative" CHECK("login_failures"."fail_count" >= 0)
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_roles_name_nocase` ON `roles` ("name" COLLATE NOCASE);--> statement-breakpoint
CREATE INDEX `idx_roles_level` ON `roles` (`level`,`id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_sessions_user_created` ON `sessions` (`user_id`,`created_at`,`token_digest`);--> statement-breakpoint
CREATE INDEX `idx_sessions_expires` ON `sessions` (`expires_at`,`token_digest`);--> statement-breakpoint
CREATE INDEX `idx_sessions_created` ON `sessions` (`created_at`,`token_digest`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_users_username_nocase` ON `users` ("username" COLLATE NOCASE);--> statement-breakpoint
CREATE INDEX `idx_users_roster` ON `users` (`deleted_at`,`is_active`,`created_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_users_roster_all` ON `users` (`deleted_at`,`created_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_users_role` ON `users` (`role_id`,`deleted_at`,`is_active`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_error_log_created` ON `error_log` (`created_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_error_log_source_created` ON `error_log` (`source`,`created_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_error_log_request` ON `error_log` (`request_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_event_class_quotas_tag` ON `event_class_quotas` (`tag_id`,`event_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_event_participants_event_user` ON `event_participants` (`event_id`,`user_id`);--> statement-breakpoint
CREATE INDEX `idx_event_participants_event_joined` ON `event_participants` (`event_id`,`joined_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_event_participants_user_event` ON `event_participants` (`user_id`,`event_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_event_poll_options_event_sort` ON `event_poll_options` (`event_id`,`sort_order`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_event_poll_votes_event_user` ON `event_poll_votes` (`event_id`,`user_id`,`option_id`);--> statement-breakpoint
CREATE INDEX `idx_event_poll_votes_user` ON `event_poll_votes` (`user_id`,`event_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `event_raffle_draws_mutation_token_unique` ON `event_raffle_draws` (`mutation_token`);--> statement-breakpoint
CREATE INDEX `idx_event_raffle_draws_drawn` ON `event_raffle_draws` (`drawn_at`,`event_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_event_raffle_winners_event_user` ON `event_raffle_winners` (`event_id`,`user_id`);--> statement-breakpoint
CREATE INDEX `idx_event_raffle_winners_event` ON `event_raffle_winners` (`event_id`,`drawn_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_event_raffle_winners_user` ON `event_raffle_winners` (`user_id`,`event_id`);--> statement-breakpoint
CREATE TABLE `events` (
	`id` text PRIMARY KEY NOT NULL,
	`type` text NOT NULL,
	`title` text NOT NULL,
...
--> statement-breakpoint
CREATE INDEX `idx_events_public_start` ON `events` (`archived_at`,`visible_at`,`start_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_events_list_start` ON `events` (`start_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_events_type_start` ON `events` (`type`,`start_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_events_pinned_start` ON `events` (`pinned`,`start_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_events_locked_start` ON `events` (`signup_locked`,`start_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_events_auto_archive_due` ON `events` (`auto_archive`,`auto_archived`,`archived_at`,`end_at`,`start_at`);--> statement-breakpoint
CREATE INDEX `idx_events_raffle_due` ON `events` (`type`,`archived_at`,`end_at`,`id`);--> statement-breakpoint
CREATE UNIQUE INDEX `ux_events_series_instance` ON `events` (`series_id`,`instance_date`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_recurring_template_class_quotas_tag` ON `recurring_template_class_quotas` (`tag_id`,`template_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_recurring_template_weekdays_weekday` ON `recurring_template_weekdays` (`weekday`,`template_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_recurring_templates_active` ON `recurring_templates` (`paused`,`id`);--> statement-breakpoint
CREATE INDEX `idx_recurring_templates_created_by` ON `recurring_templates` (`created_by`,`created_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_gallery_items_created` ON `gallery_items` (`created_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_gallery_items_type_created` ON `gallery_items` (`type`,`created_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_gallery_items_owner_created` ON `gallery_items` (`uploaded_by`,`type`,`created_at`,`id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_guild_wars_event` ON `guild_wars` (`event_id`);--> statement-breakpoint
CREATE INDEX `idx_guild_wars_active_event` ON `guild_wars` (`status`,`event_id`,`id`);--> statement-breakpoint
CREATE INDEX `idx_guild_wars_history_created` ON `guild_wars` (`status`,`created_at`,`id`);--> statement-breakpoint
CREATE UNIQUE INDEX `ux_guild_wars_mutation_token` ON `guild_wars` (`mutation_token`) WHERE "guild_wars"."mutation_token" IS NOT NULL;--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_war_members_war_user` ON `war_members` (`war_id`,`user_id`);--> statement-breakpoint
CREATE INDEX `idx_war_members_team_sort` ON `war_members` (`team_id`,`sort_order`,`id`);--> statement-breakpoint
CREATE INDEX `idx_war_members_war_pool_sort` ON `war_members` (`war_id`,`team_id`,`sort_order`,`id`);--> statement-breakpoint
CREATE INDEX `idx_war_members_user_war` ON `war_members` (`user_id`,`war_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_war_teams_war_id_id` ON `war_teams` (`war_id`,`id`);--> statement-breakpoint
CREATE INDEX `idx_war_teams_war_sort` ON `war_teams` (`war_id`,`sort_order`,`id`);--> statement-breakpoint
CREATE TABLE `media_assets` (
	...
	CONSTRAINT "media_assets_purpose_valid" CHECK("media_assets"."purpose" IN ('member_avatar', 'member_image', 'member_audio', 'gallery_image', 'event_image', 'announcement_image', 'wiki_image', 'storage_image', 'class_icon', 'site_logo')),
	CONSTRAINT "media_assets_type_valid" CHECK("media_assets"."media_type" IN ('image', 'audio')),
	CONSTRAINT "media_assets_state_valid" CHECK("media_assets"."state" IN ('uploading', 'staged', 'attached', 'deleting')),
	CONSTRAINT "media_assets_purpose_type_consistent" CHECK(("media_assets"."purpose" = 'member_audio' AND "media_assets"."media_type" = 'audio') OR ("media_assets"."purpose" <> 'member_audio' AND "media_assets"."media_type" = 'image')),
	CONSTRAINT "media_assets_name_consistent" CHECK(("media_assets"."media_type" = 'audio' AND length(trim("media_assets"."original_name")) BETWEEN 1 AND 255) OR ("media_assets"."media_type" = 'image' AND "media_assets"."original_name" IS NULL)),
...
CREATE TABLE `media_variants` (
	...
	CONSTRAINT "media_variants_dimensions_consistent" CHECK(("media_variants"."content_type" = 'image/webp' AND "media_variants"."width" > 0 AND "media_variants"."height" > 0) OR ("media_variants"."content_type" = 'audio/ogg' AND "media_variants"."width" IS NULL AND "media_variants"."height" IS NULL))
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_class_catalog_label_nocase` ON `class_catalog` ("label" COLLATE NOCASE);--> statement-breakpoint
CREATE INDEX `idx_class_catalog_sort` ON `class_catalog` (`sort_order`,`id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_class_tag_members_class` ON `class_tag_members` (`class_id`,`tag_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_class_tags_catalog_label_nocase` ON `class_tags` ("label" COLLATE NOCASE) WHERE "class_tags"."owner_kind" IS NULL;--> statement-breakpoint
CREATE INDEX `idx_class_tags_sort` ON `class_tags` (`owner_kind`,`sort_order`,`id`);--> statement-breakpoint
CREATE INDEX `idx_class_tags_owner` ON `class_tags` (`owner_kind`,`owner_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_member_absences_user_start` ON `member_absences` (`user_id`,`start_date`,`id`);--> statement-breakpoint
CREATE INDEX `idx_member_absences_window` ON `member_absences` (`end_date`,`start_date`,`user_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_member_availability_lookup` ON `member_availability_windows` (`weekday`,`start_minute`,`end_minute`,`user_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_member_badge_assignments_user` ON `member_badge_assignments` (`user_id`,`badge_id`);--> statement-breakpoint
CREATE INDEX `idx_member_badge_assignments_actor` ON `member_badge_assignments` (`assigned_by`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_member_badges_name_nocase` ON `member_badges` ("name" COLLATE NOCASE);--> statement-breakpoint
CREATE INDEX `idx_member_badges_sort` ON `member_badges` (`sort_order`,`id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_member_profile_classes_sort` ON `member_profile_classes` (`user_id`,`sort_order`);--> statement-breakpoint
CREATE INDEX `idx_member_profile_classes_class` ON `member_profile_classes` (`class_id`,`user_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_member_profile_videos_sort` ON `member_profile_videos` (`user_id`,`sort_order`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `app_migrations_ordinal_unique` ON `app_migrations` (`ordinal`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_storage_balances_quantity_item` ON `storage_balances` (`quantity`,`item_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_storage_batches_actor_idempotency` ON `storage_batches` (`actor_id`,`idempotency_key`) WHERE "storage_batches"."idempotency_key" IS NOT NULL;--> statement-breakpoint
CREATE INDEX `idx_storage_batches_actor_created_id` ON `storage_batches` (`actor_id`,`created_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_storage_batches_recipient_created_id` ON `storage_batches` (`recipient_user_id`,`created_at`,`id`) WHERE "storage_batches"."recipient_user_id" IS NOT NULL;--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_storage_categories_storage_id` ON `storage_categories` (`storage_id`,`id`);--> statement-breakpoint
CREATE INDEX `idx_storage_categories_storage_name_id` ON `storage_categories` (`storage_id`,`name`,`id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_storage_items_storage_name_id` ON `storage_items` (`storage_id`,`name`,`id`);--> statement-breakpoint
CREATE INDEX `idx_storage_items_storage_category_name_id` ON `storage_items` (`storage_id`,`category_id`,`name`,`id`);--> statement-breakpoint
CREATE INDEX `idx_storage_items_category_name_id` ON `storage_items` (`category_id`,`name`,`id`);--> statement-breakpoint
CREATE INDEX `idx_storage_items_member_deposit` ON `storage_items` (`storage_id`,`name`,`id`) WHERE "storage_items"."allow_member_deposit" = 1;--> statement-breakpoint
CREATE INDEX `idx_storage_items_member_withdraw` ON `storage_items` (`storage_id`,`name`,`id`) WHERE "storage_items"."allow_member_withdraw" = 1;--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_storage_ledger_batch_position` ON `storage_ledger_entries` (`batch_id`,`batch_position`);--> statement-breakpoint
CREATE UNIQUE INDEX `ux_storage_ledger_batch_item` ON `storage_ledger_entries` (`batch_id`,`item_id`);--> statement-breakpoint
CREATE INDEX `idx_storage_ledger_created_id` ON `storage_ledger_entries` (`created_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_storage_ledger_item_created_id` ON `storage_ledger_entries` (`item_id`,`created_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_storage_ledger_actor_created_id` ON `storage_ledger_entries` (`actor_id`,`created_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_storage_ledger_recipient_created_id` ON `storage_ledger_entries` (`recipient_user_id`,`created_at`,`id`) WHERE "storage_ledger_entries"."recipient_user_id" IS NOT NULL;--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_storages_name_id` ON `storages` (`name`,`id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_system_test_artifacts_cleanup` ON `system_test_artifacts` (`run_id`,`artifact_type`,`artifact_key`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_system_test_before_images_cleanup` ON `system_test_before_images` (`run_id`,`target_type`,`target_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_system_test_requests_run` ON `system_test_requests` (`run_id`,`started_at`,`request_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_system_test_runs_actor` ON `system_test_runs` (`actor_user_id`,`created_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_system_test_runs_expiry` ON `system_test_runs` (`status`,`expires_at`,`id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_wiki_articles_slug` ON `wiki_articles` (`slug`);--> statement-breakpoint
CREATE INDEX `idx_wiki_articles_category_curated` ON `wiki_articles` (`category_id`,`archived_at`,`pinned`,`sort_order`,`title`,`id`);--> statement-breakpoint
CREATE INDEX `idx_wiki_articles_public_curated` ON `wiki_articles` (`deleted_at`,`archived_at`,"pinned" DESC,`sort_order`,`title`,`id`);--> statement-breakpoint
CREATE INDEX `idx_wiki_articles_admin_curated` ON `wiki_articles` (`deleted_at`,"pinned" DESC,`sort_order`,`title`,`id`);--> statement-breakpoint
CREATE INDEX `idx_wiki_articles_admin_updated` ON `wiki_articles` (`deleted_at`,`updated_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_wiki_articles_visibility_updated` ON `wiki_articles` (`archived_at`,`updated_at`,`id`);--> statement-breakpoint
CREATE INDEX `idx_wiki_articles_deleted` ON `wiki_articles` (`deleted_at`,`id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `ux_wiki_categories_slug` ON `wiki_categories` (`slug`);--> statement-breakpoint
CREATE INDEX `idx_wiki_categories_tree_order` ON `wiki_categories` (`parent_id`,`sort_order`,`name`,`id`);--> statement-breakpoint
...
--> statement-breakpoint
-- modular-backend-invariants-and-seed
...
INSERT INTO site_config (
  ...
  1, 1, 1, 1,
  1, 1, 1,
  2097152, 524288, 5242880, 20971520,
